...
export const ScoreGuide: React.FC<ScoreGuideProps> = ({ onClose }) => {
  const scoreGuides = [
    ...
    { score: 0, label: 'Unacceptable', description: 'Does not meet any requirements or no response provided' }
  ];
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
        ...
        <div className="p-6">
          <div className="space-y-4">
            {scoreGuides.map(({ score, label, description }) => (
