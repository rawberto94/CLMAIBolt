  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glass-hover': '0 8px 24px 0 rgba(99, 102, 241, 0.12)',
        'card': '0 2px 4px 0 rgba(0, 0, 0, 0.05)',
        'card-hover': '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
        'neumorph': '6px 6px 12px #e0e0e0, -6px -6px 12px #ffffff',
        'neumorph-inset': 'inset 6px 6px 12px #e0e0e0, inset -6px -6px 12px #ffffff',
